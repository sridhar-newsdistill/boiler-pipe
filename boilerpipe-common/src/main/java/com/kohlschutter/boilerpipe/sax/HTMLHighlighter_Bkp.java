...
import com.kohlschutter.boilerpipe.sax.HTMLHighlighter.Implementation;
import com.kohlschutter.boilerpipe.sax.HTMLHighlighter.TagAction;

public class HTMLHighlighter_Bkp {
	        ...
	        if (inIgnorableElement == 0) {
	          ...
	          if (!ignoreAttrs) {
	           ...
	           for (int i = 0; i < numAtts; i++) {
	              ...
	              if(isContentBitSet&&(qName.equalsIgnoreCase("img")||qName.equalsIgnoreCase("a")||qName.equalsIgnoreCase("IFRAME")||("style".equalsIgnoreCase(attr)&&(data != null && data.toLowerCase().contains("display:none")))))
	              {
	            	  targetHtml.append(' ');
