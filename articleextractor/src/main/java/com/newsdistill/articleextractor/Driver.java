...
public class Driver {
  ...
  static String regExForAnchorTagRemoval =
  ...
  public static void main(String[] args) throws IOException {
    ...
    // String data = null;//
    // Utils.getHtmlAsString("http://www.sakshieducation.com/EnglishStory.aspx?cid=2&sid=115&nid=117796");
    BaseArticleExractor article =
        new ContentExtractor("http://www.sakshi.com/photos/news/album-best-photos-in-sakshi-4134", 0);
