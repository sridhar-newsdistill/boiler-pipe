...
public class ApplicationConstants {
  ...
  public static final Pattern patternForFindingExactTagName =
      Pattern.compile(REGEX_TO_FIND_CLEAN_TG_NAME_FROM_ATTRIBUTE_ENABLD_TAG);
  ...
  public static final Pattern patternForTitleExtraction =
      Pattern.compile(regexForTitleExtraction, Pattern.CASE_INSENSITIVE);
